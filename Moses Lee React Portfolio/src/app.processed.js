...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _HomePage = __webpack_require__(334);

	var _HomePage2 = _interopRequireDefault(_HomePage);

	var _AboutPage = __webpack_require__(346);

	var _AboutPage2 = _interopRequireDefault(_AboutPage);

	var _PensPage = __webpack_require__(348);

	var _PensPage2 = _interopRequireDefault(_PensPage);

	var _AppWrapper = __webpack_require__(350);
	...
	var createStoreWithMiddleware = (0, _redux.applyMiddleware)()(_reactRedux.createStore);
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_reactRouterDom.Route, { path: '/codepens', component: _PensPage2.default }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {(function (global, factory) {
		 true ? factory(exports, __webpack_require__(328), __webpack_require__(331)) :
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ParticleCanvas = __webpack_require__(335);

	var _ParticleCanvas2 = _interopRequireDefault(_ParticleCanvas);

	var _OnVisible = __webpack_require__(337);

	var _OnVisible2 = _interopRequireDefault(_OnVisible);

	var _Button = __webpack_require__(340);

	var _Button2 = _interopRequireDefault(_Button);

	var _PenCard = __webpack_require__(341);

	var _PenCard2 = _interopRequireDefault(_PenCard);

	var _LoadingModal = __webpack_require__(342);

	var _LoadingModal2 = _interopRequireDefault(_LoadingModal);

	var _pens = __webpack_require__(343);

	var penActions = _interopRequireWildcard(_pens);
	...
	var HomePage = function (_React$Component) {
		...
		_createClass(HomePage, [{
			...
			value: function render() {
				var _props$pens = this.props.pens,
				    data = _props$pens.data,
				    loading = _props$pens.loading;


				var popPens = void 0;
				if (loading) {
					popPens = _react2.default.createElement(_LoadingModal2.default, {
						loadingText: 'Loading Popular Pens...'
					});
				} else {
					popPens = Object.values(data).slice(0, 3).map(function (pen) {
						return _react2.default.createElement(_PenCard2.default, {
							title: pen.title,
				...
				return _react2.default.createElement(
					'div',
					{ className: 'HomePage' },
					_react2.default.createElement(_ParticleCanvas2.default, null),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'PopularPens__content' },
								_react2.default.createElement(
									'div',
									{ className: 'PopularPens__wrapper' },
									_react2.default.createElement(
										'h1',
										null,
										'Recent Pens'
	...
	function mapDispatchToProps(dispatch) {
		return {
			actions: (0, _redux.bindActionCreators)(penActions, dispatch)
		};
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _utilities = __webpack_require__(336);
	...
	var cloudBlue = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/280549/cloud-blue-green.png';
	var cloudPurple = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/280549/cloud-purple.png';

	var ParticleCanvas = function (_React$PureComponent) {
		_inherits(ParticleCanvas, _React$PureComponent);
		...
		function ParticleCanvas() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ParticleCanvas.__proto__ || Object.getPrototypeOf(ParticleCanvas)).call.apply(_ref, [this].concat(args))), _this), _this.particles = {
				particles: [],
				count: 30,
				lineWidth: 1.5,
				lineColors: ['#1c7685'],
		...
		_createClass(ParticleCanvas, [{
			...
			value: function updateClouds() {
				var clouds = this.particles.clouds;
				var W = this.W,
				    H = this.H;
			...
			value: function getDistance(p1, p2) {
				var _particles2 = this.particles,
				    minDist = _particles2.minDist,
				    lineWidth = _particles2.lineWidth,
				    lineColors = _particles2.lineColors;
				var ctx = this.ctx;
				...
				if (dist <= minDist) {
					ctx.beginPath();
					ctx.strokeStyle = (0, _utilities.hexToRgbA)((0, _utilities.randomColorFromArray)(lineColors), 1.2 - dist / minDist);
			...
			value: function animLoop() {
				this.draw();
				(0, _utilities.requestAnimationFrame)(this.animLoop.bind(this));
			}
		}, {
			key: 'drawParticle',
			...
			key: 'createSmokeCloud',
			value: function createSmokeCloud() {
				var H = this.H,
				    W = this.W;

				var img = new Image();

				var cloudsArr = [cloudBlue, cloudPurple];

				var pic = cloudsArr[Math.floor(Math.random() * cloudsArr.length)];
				img.src = pic;
				...
				var randVelocity = Math.random() > 0.5;
				if (randVelocity) {
			...
			key: 'loadSmokeClouds',
			value: function loadSmokeClouds() {
				var _particles3 = this.particles,
				    cloudMax = _particles3.cloudMax,
				    clouds = _particles3.clouds;


				for (var i = 0; i < cloudMax; i += 1) {
			...
			key: 'render',
			value: function render() {
				return _react2.default.createElement('canvas', { className: 'ParticleCanvas', ref: 'canvas' });
			}
		}]);
...
/***/ (function(module, exports) {
	...
	exports.randomColorFromArray = randomColorFromArray;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var OnVisible = function (_React$Component) {
		_inherits(OnVisible, _React$Component);

		function OnVisible(props) {
			_classCallCheck(this, OnVisible);

			var _this = _possibleConstructorReturn(this, (OnVisible.__proto__ || Object.getPrototypeOf(OnVisible)).call(this, props));

			_this.handleScroll = debounce(_this.handleScroll.bind(_this), 100);
		...
		_createClass(OnVisible, [{
			...
			value: function handleScroll() {
				var elTop = this.__rootEl.offsetTop;
				console.log(elTop);
				var isVisible = window.scrollY > elTop + (this.props.offset || 0);
			...
			value: function render() {
				...
				var outClasses = (0, _classnames2.default)('OnVisible', {
					visible: this.state.isVisible
				}, [].concat(_toConsumableArray(this.props.className)));

				return _react2.default.createElement(
					'section',
					{ className: outClasses, ref: function ref(el) {
							return _this2.__rootEl = el;
						} },
					_react2.default.createElement(
						'div',
						{ className: 'OnVisible__wrapper' },
						children
					)
				);
			}
	...
	OnVisible.propTypes = {
		...
		changeHandle: _propTypes2.default.func
		};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!function(){"use strict";function e(){for(var r=[],o=0;o<arguments.length;o++){var f=arguments[o];if(f){var i=typeof f;if("string"===i||"number"===i)r.push(f);else if(Array.isArray(f))r.push(e.apply(null,f));else if("object"===i)for(var t in f)n.call(f,t)&&f[t]&&r.push(t)}}return r.join(" ")}var n={}.hasOwnProperty;"undefined"!=typeof module&&module.exports?module.exports=e: true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function(){return e}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)):window.classNames=e}();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PenCard = function (_React$PureComponent) {
		_inherits(PenCard, _React$PureComponent);

		function PenCard() {
			_classCallCheck(this, PenCard);

			return _possibleConstructorReturn(this, (PenCard.__proto__ || Object.getPrototypeOf(PenCard)).apply(this, arguments));
		}

		_createClass(PenCard, [{
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'PenCard__wrapper' },
						_react2.default.createElement('div', { className: 'PenCard__img', style: cardStyles }),
						_react2.default.createElement(
							'div',
							{ className: 'PenCard__meta' },
							_react2.default.createElement(
								'h3',
								null,
								title
							),
							_react2.default.createElement('p', { dangerouslySetInnerHTML: { __html: details } })
						)
					),
					_react2.default.createElement('a', { href: link, className: 'PenCard__mask' })
				);
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var LoadingModal = function (_React$PureComponent) {
		_inherits(LoadingModal, _React$PureComponent);

		function LoadingModal() {
			_classCallCheck(this, LoadingModal);

			return _possibleConstructorReturn(this, (LoadingModal.__proto__ || Object.getPrototypeOf(LoadingModal)).apply(this, arguments));
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.actionNames = undefined;
	exports.fetchAllPens = fetchAllPens;

	var _codepen = __webpack_require__(344);
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								...
								_context.prev = 1;
								_context.next = 4;
								return (0, _codepen.getAllPens)(page);
							...
							case 12:
								...
								console.error('There was an error fetching the pens: ' + _context.t0);
								return _context.abrupt('return', dispatch({
									type: actionNames.GET_ALL_PENS_FAILED,
									payload: _context.t0
								}));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.getAllPens = exports.getPopularPens = undefined;

	var getPopularPens = exports.getPopularPens = function () {
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							_context.prev = 0;
							_context.next = 3;
							return fetch(_env2.default.codepenApiUrl + '/pens/popular/' + _env2.default.userName);
						...
						case 17:
							...
							throw new Error('There was an error fetching popular pens: ' + _context.t0);
		...
		return function getPopularPens() {
			return _ref.apply(this, arguments);
		};
	}();

	var getAllPens = exports.getAllPens = function () {
				...
				while (1) {
					switch (_context2.prev = _context2.next) {
						case 0:
							_context2.prev = 0;
							_context2.next = 3;
							return fetch(_env2.default.codepenApiUrl + '/pens/public/' + _env2.default.userName + '?page=' + page);
						...
						case 10:
							...
							throw new Error('There was an error fetching popular pens: ' + _context2.t0);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Banner = __webpack_require__(347);
	...
	var AboutPage = function (_React$PureComponent) {
		...
		_createClass(AboutPage, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'AboutPage' },
					_react2.default.createElement(_Banner2.default, { bgImg: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/280549/trees.jpg' }),
					_react2.default.createElement(
						'div',
						{ className: 'AboutPage__content  masked--top' },
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								'p',
								null,
								'I am passionate about creating stunning and functional websites using various tools and methods commonly used in the industry today. I have created this project to challenge myself to create something different and showcase some of my skills. I am currently happily employed at ',
								_react2.default.createElement(
									'a',
									{ href: 'https://zhanglab.ccmb.med.umich.edu/COVID-19/' },
									'Zhanglabs'
								),
								' in Missoula, MT working as a fullstack web-dev creating Wordpress and React sites. Feel free to ',
								_react2.default.createElement(
									'a',
									{ href: 'mailto:moses555@protonmail.com' },
									'shoot me a message'
								),
								', or visit ',
								_react2.default.createElement(
									'a',
									{ href: 'https://github.com/moses555', target: '__blank' },
									'my Github page'
								),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Banner = function (_React$Component) {
		...
		_createClass(Banner, [{
			...
			value: function render() {
				...
				var childrenCont = this.props.children ? '<div className="Banner__content">' + this.props.children + '</div>' : '';

				return _react2.default.createElement(
					'div',
					{ className: 'Banner', style: styles },
					_react2.default.createElement(
						'div',
	...
	Banner.PropTypes = {
		bgImg: _react2.default.PropTypes.String
		};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Paginator = __webpack_require__(349);
	...
	var PensPage = function (_React$Component) {
		_inherits(PensPage, _React$Component);

		function PensPage(props) {
			_classCallCheck(this, PensPage);

			var _this = _possibleConstructorReturn(this, (PensPage.__proto__ || Object.getPrototypeOf(PensPage)).call(this, props));
		...
		_createClass(PensPage, [{
			...
			value: function paginationHandler(e) {
				...
				var next = this.state.currentPage + parseInt(val);
			...
			value: function render() {
				...
				var contClasses = (0, _classnames2.default)('PensPage', {
					'loading': loading
				});

				var innerContent = Object.values(data).map(function (pen) {
					console.log(pen);
					return _react2.default.createElement(_PenCard2.default, {
						title: pen.title,
						bgImg: pen.images.small,
				...
				var modal = void 0;
				if (loading) {
					modal = _react2.default.createElement(_LoadingModal2.default, {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_Banner2.default, { bgImg: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/280549/mountain-top.jpg' }),
					_react2.default.createElement(
						'div',
						{ className: 'PensPage__content masked--top' },
						_react2.default.createElement(
							'div',
							{ className: 'PensPage__wrapper' },
							_react2.default.createElement(
								'h1',
								null,
								'My Pens'
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(PensPage);
		...
		_createClass(Paginator, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'Paginator__wrapper' },
						_react2.default.createElement(
							'nav',
							{ className: 'Paginator__controls' },
							_react2.default.createElement(
								'li',
								{ className: 'Paginator__next Paginator__button' },
								_react2.default.createElement(
									'a',
									{ href: '#', onClick: this.props.onClickHandler, 'data-val': '1' },
									'Load More Pens'
								)
							)
						)
		...
		_createClass(AppWrapper, [{
			...
			value: function render() {
				if (!this.state.loaded) {
					return _react2.default.createElement(_LoadingModal2.default, { loadingText: 'Loading App...' });
				}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'AppWrapper__wrapper content' },
						this.props.children
					),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PrimaryNav = __webpack_require__(352);
	...
	var Header = function (_React$Component) {
		...
		_createClass(Header, [{
			...
			key: 'render',
			value: function render() {
				var headerClasses = (0, _classnames2.default)('Header', { 'sticky': this.state.active });
				return _react2.default.createElement(
					'header',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PrimaryNav = function (_React$Component) {
		...
		function PrimaryNav() {
			...
			return _possibleConstructorReturn(this, (PrimaryNav.__proto__ || Object.getPrototypeOf(PrimaryNav)).apply(this, arguments));
		}
		...
		_createClass(PrimaryNav, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'nav',
					{ className: 'PrimaryNav', 'aria-label': 'Primary Navigation' },
					_react2.default.createElement(
						'div',
						{ className: 'PrimaryNav__wrapper' },
						_react2.default.createElement(
							_reactRouterDom.NavLink,
							{ to: '/home' },
							_react2.default.createElement('div', { className: 'PrimaryNav__logo' })
						),
						_react2.default.createElement(
							'ul',
							{ className: 'PrimaryNav__listItems' },
							_react2.default.createElement(
								'li',
								{ className: 'PrimaryNav__listItem' },
								_react2.default.createElement(
									_reactRouterDom.NavLink,
									{ to: '/about', activeStyle: { color: '#0799df' } },
									'About'
								)
							),
							_react2.default.createElement(
								...
								_react2.default.createElement(
									_reactRouterDom.NavLink,
									{ to: '/codepens', activeStyle: { color: '#0799df' } },
									'Codepens'
								)
							)
						)
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"a",
							{ href: "https://moses555.blob.core.windows.net/$web/moses555-react/moses555.com(react)/index.html" },
							"Dev Moses"
						)
					)
				);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reduxThunk = __webpack_require__(357);

	var _reduxThunk2 = _interopRequireDefault(_reduxThunk);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var store = (0, _redux.createStore)(_reducers2.default, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__(), (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pens = __webpack_require__(356);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function pens() {
		...
		switch (action.type) {
			case _pens.actionNames.GET_ALL_PENS_STARTED:
			...
			case _pens.actionNames.GET_ALL_PENS_SUCCESS:
			...
			case _pens.actionNames.GET_ALL_PENS_FAILED:
